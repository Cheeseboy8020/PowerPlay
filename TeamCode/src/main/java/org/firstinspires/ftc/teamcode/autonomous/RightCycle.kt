    ...
    override fun initialize() {
        ...
        val goToCycle =
            drive.trajectorySequenceBuilder(START)
                ...
                .lineToSplineHeading(Pose2d(-37.5, 11.0, Math.toRadians(0.0)))
                .build()
        ...
        schedule(
            ...
            SequentialCommandGroup(
                ...
                ScoreCone(intakeArm, liftArm, intake, lift, 5, 0.71, Lift.Positions.HIGH_ANGLE, turret, 0.025, 0.57, 3000),
                InstantCommand({intake.retractFull()}),
